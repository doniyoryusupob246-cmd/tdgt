    ...
    <>
      ...
      <div className='flex justify-center flex-col mt-10 shadow-lg w-[90%] max-w-[500px] mx-auto items-center p-5 bg-[#00ABC2] text-white rounded-xl'>
        <div className='flex flex-col items-center'>
          ...
          <p className={`${libreBaskerville.className} text-[11px] md:text-lg text-white leading-relaxed max-w-2xl px-2 md:px-4 text-center`}>Türk Dünyası Gençliğinin bir araya geldiği yer</p>
        </div>
